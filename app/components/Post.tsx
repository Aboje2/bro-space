...
export const Post = observer(function Post(props: PostProps) {
  const { username, connectionStatus, text, media, images, postId, topic, categoryId } = props
  ...
  return (
    <View style={styles.contentContainer}>
      ...
      <Text weight="light" size="sm" style={styles.textColor} text={topic} />
      ...
      <View style={[styles.textSpacing]}>
        ...
        <TouchableOpacity
          onPress={() =>
            navigation.navigate("CategoryPostDetail", { catPostId: postId, catId: categoryId })
          }
